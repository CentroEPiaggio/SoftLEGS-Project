...
% addpath('C:\Users\Silvia\Documents\MATLAB\casadi-matlabR2014b-v3.1.1')
import casadi.*
...
name1 =[ 'nh_G_Run_Soft_K_',num2str(VAL),'_experiments_EV_',num2str(ExpVal*100),'New_Set/']; 
...
Walk_Speed_norm=Walk_Speed./sqrt(g*l);
% Step_L_norm=(Walk_Speed.^0.42);

alpha_run = 1.068;

Step_L_norm=alpha_run*(Walk_Speed.^ExpVal);
