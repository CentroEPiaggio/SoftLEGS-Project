classdef SX < casadi.MatrixCommon & casadi.ExpSX & casadi.GenSX & casadi.PrintSX
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(615, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(616, varargin{:});
    end
    ...
    %JAC 
    %
    %  SX = JAC(Function f, int iind, int oind, bool compact, bool symmetric)
    %  SX = JAC(Function f, char iname, int oind, bool compact, bool symmetric)
    %  SX = JAC(Function f, int iind, char oname, bool compact, bool symmetric)
    %  SX = JAC(Function f, char iname, char oname, bool compact, bool symmetric)
    %
    %
    ...
    %GRAD 
    %
    %  SX = GRAD(Function f, int iind, int oind)
    %  SX = GRAD(Function f, char iname, int oind)
    %  SX = GRAD(Function f, int iind, char oname)
    %  SX = GRAD(Function f, char iname, char oname)
    %
    %
    ...
    %TANG 
    %
    %  SX = TANG(Function f, int iind, int oind)
    %  SX = TANG(Function f, char iname, int oind)
    %  SX = TANG(Function f, int iind, char oname)
    %  SX = TANG(Function f, char iname, char oname)
    %
    %
    ...
    %HESS 
    %
    %  SX = HESS(Function f, int iind, int oind)
    %  SX = HESS(Function f, char iname, int oind)
    %  SX = HESS(Function f, int iind, char oname)
    %  SX = HESS(Function f, char iname, char oname)
    %
    %
     [varargout{1:nargout}] = casadiMEX(622, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(623, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(640, varargin{:});
    end
