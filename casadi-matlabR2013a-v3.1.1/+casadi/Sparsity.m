classdef Sparsity < casadi.SharedObject & casadi.SpSparsity
  ...
  methods
    ...
    %SANITY_CHECK Check if the dimensions and colind, row vectors are compatible.
    %
    ...
    %
    %
      out = casadiMEX(117, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
    ...
    %ISRESHAPE Check if the sparsity is a reshape of another.
    %
    %  bool = ISRESHAPE(self, Sparsity y)
    %
    %
    %
    %
    ...
    %
    %  Sparsity = COMBINE(self, Sparsity y, bool f0x_is_zero, bool fx0_is_zero)
    %
    ...
    %
    %  [int , [int] OUTPUT, [int] OUTPUT, [int] OUTPUT, [int] OUTPUT, [int] OUTPUT, [int] OUTPUT] = BTF(self, int seed)
    %
    ...
    %DISP Describe the nonzero location k as a string.
    %
    %  char = DISP(self, int k)
    %
    %
    %
    %
    ...
    function varargout = print_compact(self,varargin)
    %PRINT_COMPACT Print a compact description of the sparsity pattern.
    %
    %  PRINT_COMPACT(self)
    %
    %
    ...
    %  new_obj = SPARSITY(int nrow, int ncol, [int] colind, [int] row)
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(90, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(91, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(92, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(93, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(94, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(95, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(96, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(97, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(98, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(100, varargin{:});
    end
