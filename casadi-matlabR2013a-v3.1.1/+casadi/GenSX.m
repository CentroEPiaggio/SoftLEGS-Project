classdef GenSX < casadi.GenericMatrixCommon & casadi.SpSX
  ...
  methods
    ...
    %
    %
      out = casadiMEX(310, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(323, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(324, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(325, varargin{:});
    end
  end
end
