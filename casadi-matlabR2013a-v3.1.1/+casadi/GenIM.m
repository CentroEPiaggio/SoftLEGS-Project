classdef GenIM < casadi.GenericMatrixCommon & casadi.SpIM
  ...
  methods
    ...
    %
    %
      out = casadiMEX(258, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(261, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(262, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(263, self, varargin{:});
    end
