classdef GenDM < casadi.GenericMatrixCommon & casadi.SpDM
  ...
  methods
    ...
    %
    %
      out = casadiMEX(284, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(297, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(298, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(299, varargin{:});
    end
  end
end
